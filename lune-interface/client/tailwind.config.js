  ...
  theme: {
    ...
    extend: {
      ...
      borderRadius: {
        ...
        '2xl': '1rem',
        '3xl': '1.5rem',
        pill: '24px', // Added from prompt
      },
      colors: { // Added from prompt
        gold: {
          100: '#FFF6C2',
          200: '#FCD44D',
          300: '#E7B94C',
      ...
      boxShadow: {
        gold: '0 0 10px 2px rgba(252,212,77,0.65)', // Added from prompt
        insetSoft: 'inset 0 1px 3px rgba(255,255,255,0.08)', // Added from prompt
